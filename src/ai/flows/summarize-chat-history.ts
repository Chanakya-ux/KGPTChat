...
/**
 * @fileOverview Summarizes the chat history, takes in an array of messages
 * and returns a summary of the chat.
 *
 * - summarizeChatHistory - A function that handles the chat summary process.
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert summarizer of chat history.

  Given the following chat history, summarize the chat in a few sentences.
